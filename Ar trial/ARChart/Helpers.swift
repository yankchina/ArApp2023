...
public struct Colors {
    ...
    public static let LegendColor:Color = Color(hexString: "#C0C0C0")
...
public struct GradientColors {
    ...
    public static let ARyellow = GradientColor(start: Color.yellow.opacity(0.9), end: Color.yellow.opacity(0.9))
    public static let ARyellow1 = GradientColor(start: Color(hexString: "FEFB00").opacity(0.9), end: Color(hexString: "FEFB00").opacity(0.9))
    public static let ARyellow2 = GradientColor(start: Color(hexString: "FEFC78").opacity(0.9), end: Color(hexString: "FEFC78").opacity(0.9))
    public static let ARblue = GradientColor(start: Color.blue.opacity(0.9), end: Color.blue.opacity(0.9))
    public static let ARblue1 = GradientColor(start: Color(hexString:"75D5FF").opacity(0.9), end: Color(hexString:"75D5FF").opacity(0.9))
    public static let ARblue2 = GradientColor(start: Color(hexString:"00FCFF").opacity(0.9), end: Color(hexString:"00FCFF").opacity(0.9))
    public static let ARred = GradientColor(start: Color.red.opacity(0.9), end: Color.red.opacity(0.9))
    public static let ARpriamry = GradientColor(start: Color.primary, end: Color.primary)
}
...
public struct ChartForm {
    #if os(watchOS)
    public static let small = CGSize(TextFieldWidth:120, height:90)
    public static let medium = CGSize(TextFieldWidth:120, height:160)
    public static let large = CGSize(TextFieldWidth:180, height:90)
    public static let extraLarge = CGSize(TextFieldWidth:180, height:90)
    public static let detail = CGSize(TextFieldWidth:180, height:160)
    #else
